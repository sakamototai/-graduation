...
部分です。<br>
この場合、slide1画像のみが表示されます。（上のcssは、slide0,slide2,slide3を非表示にする設定）</p>
...
を削除して下さい。<br>
その後、index.htmlのhtml側の最後にあるスライドショー画像から、表示させたい画像以外を削除して下さい。</p>

<h3>アニメーションを全てストップしたい場合</h3>
<p>style.cssや、style-top.css冒頭にある、<br>
<span class="look">@import url(&quot;keyframes.css&quot;);</span><br>
を削除して下さい。<br>
テンプレートを編集をする際に、アニメーションが邪魔な場合にも有効です。その場合は削除でなく一時的にコメントアウトして適用されないようにして下さい。</p>
...
補足：cssファイルのドット(.)と、htmlファイルのclassは同じ意味です。単にcssファイルとhtmlにより表記方法が異なるだけです。</p>
