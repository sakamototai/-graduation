...
<head>
    ...
    <title>カレンダー(書き込んだ内容はCookieに保存します)</title>
    <script type="text/javascript" charset="utf-8" src="js/holiday.js"></script>
    <script type="text/javascript" charset="utf-8" src="js/calendar_db_cookie.js"></script>
...
<body class="bg2">
    ...
    <div id="container">
        ...
        <div id="main">
            ...
            <body>
                <h1>こちらでスケジュールを入力してください</h1>
                <script type="text/javascript">
                 CalendarApp.placeCalendar();
                </script>
                <noscript>
