...
<body class="bg2">
    ...
    <div id="container">
        ...
        <header>
            ...
            <h2>ONLINE<span>オンライン相談</span></h2>
            <!--PC用（901px以上端末）メニュー-->
            <nav id="menubar">
                <ul>
        ...
        <div id="main">
            ...
            <section>
                ...
                <h3>利用規約のご案内</h3>
                <p>このテンプレートは、<a href="https://template-party.com/">Template Party</a>にて無料配布している『ケーキショップ向け 無料ホームページテンプレート
                    tp_cute2』です。必ずダウンロード先のサイトの<a href="https://template-party.com/read.html">利用規約</a>をご一読の上でご利用下さい。</p>
                ...
                <p>これらのファイルは全て<a href="https://www.crytus.info/"
                    ...
                    また、当サイトのテンプレート以外に使いたいなど、「プログラムのみ」を使う場合は<a
                        href="https://template-party.com/free_program/openclose_license.html">こちらの規約</a>をお守り下さい。</p>
            ...
            <section>
                ...
                <p>※注意：cssはリアルタイムで反映されますが、javascript(js)はブラウザを再読み込みさせないと反映されないので、レイアウトが切り替わったらブラウザを再読み込みさせて下さい。</p>
            ...
            <section>
                ...
                <p><strong class="color1">titleタグの設定はとても重要です。念入りにワードを選んで適切に入力しましょう。</strong><br>
                    ...
                    <span class="look">&lt;title&gt;ケーキショップ向け 無料ホームページテンプレート tp_cute2&lt;/title&gt;</span><br>
                    を編集しましょう。<br>
                    あなたのホームページ名が「Macarron Shop」だとすれば、<br>
                ...
                <p><strong class="color1">copyrightを変更しましょう。</strong><br>
                    続いてhtmlの下の方にある、<br>
                    <span class="look">Copyright&copy; Macarron Shop All Rights Reserved.</span><br>
                    の部分もあなたのサイト名に変更します。
                </p>
                ...
                <p><strong class="color1">h1ロゴのaltタグも変更しましょう。</strong><br>
                    html側に、<br>
                    <span class="look">alt=&quot;Macarron Shop&quot;</span><br>
                    となっている箇所があるので、この部分もあなたのサイト名に変更しましょう。
                </p>

                <h3>左上にある白いロゴ画像について</h3>
                <p>文字なしの土台画像がbaseフォルダに入っていますのでそれにサイト名をのせてimagesフォルダに上書きして下さい。画像の大きさは自由に変更してもらっても構いませんがある程度大きくしておいた方が高解像度の端末で鮮明に見えます。
                </p>

                <h3>ロゴ下の色のついた大見出し</h3>
                <p>こちらは、文字は直接htmlに記入されていますので必要に応じて入れ替えて下さい。<br>
                    あまり文字数が長いと飛び出るのでコンパクトにして下さい。</p>

                <h3>トップページのスライドショーについて</h3>
                <p>cssフォルダのstyle-top.cssとkeyframes.cssで設定されています。</p>
                <p><strong class="color1">css3に対応した環境(IEなら10以上)でしか動作しません。</strong><br>
                    古いブラウザでは固定画像になります。<br>
                    古いブラウザ用の指定は、index.htmlのhead内の、<br>
                    <span class="look">.slide0,.slide2,.slide3 {display:none;}</span><br>
                    部分です。<br>
                    この場合、slide1画像のみが表示されます。（上のcssは、slide0,slide2,slide3を非表示にする設定）
                </p>
                <p><strong class="color1">画像を入れ替えたい場合</strong><br>
                    「0.jpg」「1.jpg」「2.jpg」「3.jpg」の3枚のjpg画像を用意してimagesフォルダに上書きして下さい。</p>
                <p>拡張子が「jpeg」や「JPG」と少し違った場合にうまく表示できない可能性があるので「jpg」で統一して下さい。画像を「jpg」にできない場合はhtml側の拡張子指定を変更しても構いません。<br>
                    画像の容量はできるだけ軽くして下さい。重いと初動の動きがガタつきます。<br>
                    画像サイズについては、cssの背景画像（cover）なので適当で構いません。ただ、縦端末、横端末で画像がトリミングされますので、切れてもおかしくない画像を用意して下さい。</p>
                <p><strong class="color1">固定画像にしたい場合</strong><br>
                    style-top.cssの冒頭にある、<br>
                    <span class="look">@import url(&quot;keyframes.css&quot;);</span><br>
                    を削除して下さい。<br>
                    その後、index.htmlのhtml側の最後にあるスライドショー画像から、表示させたい画像以外を削除して下さい。
                </p>

                <h3>アニメーションを全てストップしたい場合</h3>
                <p>style.cssや、style-top.css冒頭にある、<br>
                    <span class="look">@import url(&quot;keyframes.css&quot;);</span><br>
                    を削除して下さい。<br>
                ...
                <p>このページのように、ページによって別画像にしたい場合、まずは背景用画像を準備し（当ページならbg2.jpg）imagesフォルダに入れます。<br>
                    次に、cssフォルダのstyle.cssの冒頭の方にある、<br>
                    <span class="look">body.bg2 {background-image: url(../images/bg2.jpg);}</span><br>
                    の行のように画像を上書きするスタイルを追加して下さい。<br>
                    追加したら、あとはhtml側のbodyタグにこれを指定すればOKです。<br>
