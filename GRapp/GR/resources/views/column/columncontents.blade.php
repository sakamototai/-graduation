        ...
        <div id="main">
            ...
            <section>
                ...
                <p><strong class="color1">copyrightを変更しましょう。</strong><br> 続いてhtmlの下の方にある、
                    <br>
                    <span class="look">Copyright&copy; Macarron Shop All Rights Reserved.</span><br> の部分もあなたのサイト名に変更します。
                </p>
                ...
                <p><strong class="color1">h1ロゴのaltタグも変更しましょう。</strong><br> html側に、
                    <br>
                    <span class="look">alt=&quot;Macarron Shop&quot;</span><br> となっている箇所があるので、この部分もあなたのサイト名に変更しましょう。
                </p>
                ...
                <p><strong class="color1">css3に対応した環境(IEなら10以上)でしか動作しません。</strong><br> 古いブラウザでは固定画像になります。
                    <br> 古いブラウザ用の指定は、index.htmlのhead内の、
                    <br>
                ...
                <p><strong class="color1">固定画像にしたい場合</strong><br> style-top.cssの冒頭にある、
                    <br>
                    <span class="look">@import url(&quot;keyframes.css&quot;);</span><br> を削除して下さい。
                    <br> その後、index.htmlのhtml側の最後にあるスライドショー画像から、表示させたい画像以外を削除して下さい。
                </p>

                <h3>アニメーションを全てストップしたい場合</h3>
                <p>style.cssや、style-top.css冒頭にある、<br>
                    <span class="look">@import url(&quot;keyframes.css&quot;);</span><br> を削除して下さい。
                    <br> テンプレートを編集をする際に、アニメーションが邪魔な場合にも有効です。その場合は削除でなく一時的にコメントアウトして適用されないようにして下さい。
                </p>

                <h3>リストタグを使いたい場合の注意点</h3>
                <p>そのままではリストマークが出ませんので、リストタグを使う場合は以下のようなスタイルを追加して下さい。</p>
                <p>&lt;ul <span class="color1">class=&quot;disc&quot;</span>&gt;<br> &lt;li&gt;リストタグ&lt;/li&gt;
                    <br> &lt;li&gt;リストタグ&lt;/li&gt;
                    <br> &lt;li&gt;リストタグ&lt;/li&gt;
                    <br> &lt;/ul&gt;
                </p>
                ...
                <p>fixmenu_pagetop.jsで動作の制御を、cssフォルダのstyle.css内の<br> /*PAGE TOP（↑）設定<br> でボタンデザインを設定しています。
