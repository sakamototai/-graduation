                ...
                <div class="navi_inner">
                    ...
                    <ul class="navi_content">
                        ...
                        <li class="navi_other" id="online_consultation">
                            ...
                            <ul class=drop_other id="drop_ot">
                                <li class="listitem1"><a href="online_reserve">
                                        <div class="ja">オンライン相談予約</div>
                                    </a>
                                </li>
                                <li class="listitem2"><a href="videochat">
                                        <div class="ja">ビデオチャット</div>
                                    </a>
                                </li>
                                <li class="listitem3">
                                    <a href="chat">
                                        <div class="ja">チャット</div>
                                    </a>
                                </li>
                            </ul>
                        </li>
