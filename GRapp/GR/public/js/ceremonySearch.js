...
//     //検索ボタンをクリックした時の処理
//     wordsearch.addEventListener('click',function(){
...
//         const newElement = document.createElement("li"); //li要素作成
...
//     pfs.forEach(function(target) {
//         target.addEventListener('chenge', function() {
//             alert(target.value);
//         });
//     });
...
//     //検索ボタンがクリックされた時(エリア検索)
//     buttonSearch.addEventListener('click',selectSearch);
